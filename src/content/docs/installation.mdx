...
1. Verify Prerequisites
   ...
   - Your firewall is configured with the required ports ([setup guide](/docs/knowledge-base/server/firewall)) (if you are an advanced user you can have this configured differently)
