...
- [Changedetection](/docs/services/changedetection) - Website change detection monitor and notifications.
...
- [Dozzle](/docs/services/dozzle) -  Realtime log viewer for docker containers.
...
- [FileFlows](/docs/services/fileflows) - A file processing application that can execute actions against a file in a tree flow structure.
...
- [Nexus](/docs/services/nexus) - A repository manager that allows you to store, manage, and distribute your software artifacts.
...
- [Overseerr](/docs/services/overseerr) - a request management and media discovery tool built to work with your existing Plex ecosystem.
...
- [Plausible](/docs/services/plausible) - Simple and privacy-friendly alternative to Google Analytics.
- [Plex](/docs/services/plex) - Media server with a full-featured library management and media player.
...
- [Prowlarr](/docs/services/prowlarr) - Indexer manager/proxy which integrates with your various PVR apps.
...
- [Radarr](/docs/services/radarr) - A movie collection manager for Usenet and BitTorrent users.
...
- [Sonarr](/docs/services/sonarr) - A series collection manager for Usenet and BitTorrent users.
