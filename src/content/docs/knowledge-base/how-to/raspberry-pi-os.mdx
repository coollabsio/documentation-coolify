...
head:
  - tag: "meta"
    attrs:
        property: "og:title"
        content: "How to install the 64-bit Raspberry Pi OS version to set up Coolify on a Raspberry Pi"
...
9. After your Raspberry Pi boots up, proceed with the [Coolify installation](/docs/installation#1-quick-installation-recommended).
