...
head:
  - tag: "meta"
    attrs:
        property: "og:title"
        content: "How to setup OAuth login to Coolify"
...
To setup OAuth for a given IDP, you need to get a client id and a client secret from the authorization server.
