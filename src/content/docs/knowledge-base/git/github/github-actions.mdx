...
head:
  - tag: "meta"
    attrs:
        property: "og:title"
        content: "How to use GitHub Actions with Coolify"
...
5. Get the proper webhook endpoint from Coolify (Your resource / `Webhook` menu / `Deploy Webhook`) and add it to your GitHub repository secrets.
